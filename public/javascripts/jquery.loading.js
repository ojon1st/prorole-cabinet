...
(function(factory) {
  ...
  $.extend(Loading.prototype, {
    ...
    createOverlay: function() {
      var overlay = $('<div class="loading-overlay loading-theme-' + this.settings.theme + '"><div class="loading-overlay-content"><div> <img src="/images/ajaxloader.gif"> </div> <div>' + this.settings.message + '</div></div>')
