var Calendar = function() {
    ...
    var readFullEvents = function(el) {
        ...
        $("#readFullEvent").find(".delete-event").off().on("click", function() {
            ...
            bootbox.confirm("Etes-vous sur de supprimer", function(result) {
                if (result) {
                    $.blockUI({
                        message: '<i class="fa fa-spinner fa-spin"></i> En cours de traitement...'
                    });
                    ...
                    $.ajax({
                        ...
                        success: function(json) {
                            ...
                            if (json.say == "ok") {
                                ...
                                $.hideSubview();
                                toastr.success('L \'evement a été supprimé avec succes!');
                            }
                        }
                    });
